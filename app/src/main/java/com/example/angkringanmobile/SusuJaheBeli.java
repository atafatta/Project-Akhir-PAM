...
public class SusuJaheBeli extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.infosusujahe);
        ...
        namaSateTelur.setText("Susu Jahe");
        imageView.setImageResource(R.drawable.cartsusujahe);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SusuJaheBeli.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 3000;
                if (quantity == 0){
                    Toast.makeText(SusuJaheBeli.this, "Harus pesan minimal 1", Toast.LENGTH_SHORT).show();
                }else{
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
