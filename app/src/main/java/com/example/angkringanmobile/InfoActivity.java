...
public class InfoActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    TextView quantitynumber, namaNasiKucing, hargaNasiKucing;
    Button addtoCart;
    int quantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namaNasiKucing = findViewById(R.id.NasiKucingnama);
        hargaNasiKucing = findViewById(R.id.NasiKucingHarga);
        addtoCart = findViewById(R.id.addtocart);


        namaNasiKucing.setText("Nasi Kucing");
        ...
        plusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hargaNasiKucing.setText(setnewPrice);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 1000;
                if (quantity == 0){
                    Toast.makeText(InfoActivity.this, "Harus pesan minimal 1", Toast.LENGTH_SHORT).show();
                }else{
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
    ...
    private boolean SaveCart() {
        String name = namaNasiKucing.getText().toString();
        String price = hargaNasiKucing.getText().toString();
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()){
            ...
            namaNasiKucing.setText(nameofdrink);
            hargaNasiKucing.setText(priceofdrink);
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        namaNasiKucing.setText("");
        hargaNasiKucing.setText("");
