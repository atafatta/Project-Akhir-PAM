...
public class SateAtiOrder extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.infosateati);
        ...
        drinkName.setText("Sate Ati");
        imageView.setImageResource(R.drawable.cartsateati);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SateAtiOrder.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 2500;
                if (quantity == 0){
                    Toast.makeText(SateAtiOrder.this, "Harus pesan minimal 1", Toast.LENGTH_SHORT).show();
                }else{
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
